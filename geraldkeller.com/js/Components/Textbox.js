    ...
    return (
      React.createElement('div', {className: 'form-group' + (this.props.hasError ? 'has-error':'') } ,
        ...
        React.createElement('div', {className: 'col-sm-12 col-xs-12 col-md-12 col-lg-12 input-group'},
          React.createElement('input', {type:'text', id: 'textinput', className: 'form-control', placeholder: this.props.placeholderText, onChange: this.props.onChange, value: this.props.value}), this.props.error ?
